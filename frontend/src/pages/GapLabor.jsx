...
// Labor
// Labor pool management (dock workers, crane operators)

export default function GapLabor() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-labor', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Labor</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Labor pool management (dock workers, crane operators)</p>
