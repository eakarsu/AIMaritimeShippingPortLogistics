...
// Multi Modal
// Multi-modal incident investigation combining vessel sensors + weather + reports
...
export default function GapMultiModal() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Multi-modal incident investigation combining vessel sensors + weather + reports</p>
