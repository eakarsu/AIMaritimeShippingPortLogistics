...
// Shipper
// Shipper portal (cargo tracking, ETAs, docs)

export default function GapShipper() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-shipper', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Shipper</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Shipper portal (cargo tracking, ETAs, docs)</p>
