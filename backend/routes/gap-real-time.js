...
// Feature: Real Time
// Description: Real-time AIS integration / vessel tracking
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Real Time. Real-time AIS integration / vessel tracking' },
